 ...
 * Tokenizer
 *
 * The Tokenizer is an object-oriented abstraction for the token_get_all() function. It normalizes
 * all of the tokens into Token objects and allows iteration and seeking through the collection of
 * tokens.
 *
...
class Tokenizer implements \SeekableIterator, \Countable, \ArrayAccess, \Serializable
{
	...
	public function __construct($code)
	{
		...
		{
			throw new \InvalidArgumentException('The tokenize either expects a string of PHP code or and array of Tokens.');
		}
